...
var defaults = {
  ...
  animate : function() {
    ...
    if ( b.is ) {
      ...
      if ( this.beats % 8 == 0){
        this.advec.magnitude.multiply(-1);
       }
    } 
    ...
    if (this.gray_scott.wet.value[0] == 1.0) {
      this.diffuse_iterations = this.audio.data.levels.smooth[0] * 50;
    ...
    this["raytracer"].acc.set(this.accumulator/20.)
    this["raytracer"].time.set(this.time/20.)
