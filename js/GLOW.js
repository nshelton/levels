...
GLOW.Matrix4 = function() {
    ...
    b.prototype.GetQuaternion = function() {
        ...
        var xyz = this.getRotation();

        var c1 = Math.cos(xyz.x / 2 );
        var c2 = Math.cos(xyz.y / 2 );
        var c3 = Math.cos(xyz.z / 2 );
        var s1 = Math.sin(xyz.x / 2 );
        var s2 = Math.sin(xyz.y / 2 );
        var s3 = Math.sin(xyz.z / 2 );
    
    
        var q0 = s1 * c2 * c3 + c1 * s2 * s3;
        var q1 = c1 * s2 * c3 - s1 * c2 * s3;
        var q2 = c1 * c2 * s3 + s1 * s2 * c3;
        var q3 = c1 * c2 * c3 - s1 * s2 * s3;
