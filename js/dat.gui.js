...
/***/ function(module, exports, __webpack_require__) {
	...
	function _add(gui, object, property, params) {
	  ...
	  controller.domElement.appendChild(name);
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"dg-save\" class=\"dg dialogue\">  Here's the new load parameter for your <code>GUI</code>'s constructor:  <textarea id=\"dg-new-constructor\"></textarea>\n\n  <div id=\"dg-save-locally\">\n\n    <input id=\"dg-local-storage\" type=\"checkbox\"/> Automatically save\n    values to <code>localStorage</code> on exit.\n\n    <div id=\"dg-local-explain\">The values saved to <code>localStorage</code> will\n      override those passed to <code>dat.GUI</code>'s constructor. This makes it\n      easier to work incrementally, but <code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n\n    </div>\n\n  </div>\n\n</div>";
...
.dg {
 ...
 .dg.main::-webkit-scrollbar {
   width: 5px;
   background:rgba(0,0,0,0);// #1a1a1a;
}
 ...
 .dg.main::-webkit-scrollbar-thumb {
   border-radius: 5px;
   background:rgba(0,0,0,0);// #676767;
}
 .dg li:not(.folder) {
  height:27px;
}
 .dg li.save-row {
   line-height: 25px;
   background:rgba(0,0,0,0);// #dad5cb;
   border: 0;
}
 ...
 .dg li.save-row .button {
   ...
   background:rgba(0,0,0,0);// #c5bdad;
   color: #fff;
 ...
 .dg li.save-row .button.gears {
   background:rgba(0,0,0,0);// #c5bdad url(data:image/png;base64,) 2px 1px no-repeat;
   height: 7px;
   width: 8px;
}
 ...
 .dg li.title {
   padding-left: 16px;
   background:rgba(0,0,0,0);// #000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;
   cursor: pointer;
